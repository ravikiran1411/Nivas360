...
const PropertyStyle = ({
  ...
  const { currency, saveProperty, savedProperty, backendUrl, token } = useContext(DataContext)
  ...
  const startChat = async (e) => {
    ...
    try {
      const res = await axios.post(backendUrl + "/api/chat/start",{ownerId},{headers:{token}})
