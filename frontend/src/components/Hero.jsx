  ...
  return (
    <div className='flex bg-slate-200 border border-gray-500 mx:5 sm:mx-15 '>
        <div className='flex flex-col sm:gap-3  w-1/2 justify-center items-center pt-3'>
          ...
          <button onClick={()=>navigate('/rent')} className='bg-blue-600 text-white font-sm sm:font-medium hover:bg-blue-700 cursor-pointer px-2 py-1 sm:px-3 sm:py-3 rounded mt-3 mb-4 sm:mt-5'>Start Exploring</button>
        </div>
