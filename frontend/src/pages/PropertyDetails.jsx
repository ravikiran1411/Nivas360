  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-10">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="px-4 sm:px-6 mt-6 flex flex-col lg:flex-row gap-4">
          <div className="lg:w-[84%]">
            <img src={image} className="w-full h-[300px] sm:h-[500px] lg:h-[600px] object-cover rounded-lg"alt="" />
          </div>

          <div className="lg:w-[16%] grid grid-cols-4 sm:grid-cols-5 lg:grid-cols-1 gap-2">
            {propertyData.images.map((img, index) => (
              <img key={index} src={img} onClick={() => setImage(img)}
                className="h-20 sm:h-24 lg:h-28 w-full object-cover rounded cursor-pointer hover:opacity-80" />
            ))}
          </div>
