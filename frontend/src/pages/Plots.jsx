...
const Plots = () => {
  ...
  const propertydata = () =>{
    ...
    pcopy=pcopy.filter(property=>property.purpose==='purchase')
        ...
        <div className={`border border-slate-300 bg-slate-100 sm:block pl-5 py-5 mt-6 ${showFilter ? '': 'hidden' } `}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light'>
            <p className='flex gap-2'>
              <input type='radio' value='below20' name='price' onChange={togglepricerange} /> Below 20L
            </p>
              <p className='flex gap-2'>
              <input type='radio' value='20-30' name='price' onChange={togglepricerange} /> 20L-30L
            </p>
              <p className='flex gap-2'>
              <input type='radio' value='30-40' name='price' onChange={togglepricerange} />30L-40L
            </p>
             <p className='flex gap-2'>
              <input type='radio' value='above40' name='price' onChange={togglepricerange} />Above 40L
            </p>
          </div>
        </div>
      </div> 
