...
const House = () => {
  ...
  const propertydata = () =>{
    ...
    pcopy=pcopy.filter(property=>property.purpose==='buy')
    ...
    <div className='px-3 sm:px-10 flex flex-col sm:flex-row gap-2 sm:gap-10'>
      <div className='min-w-60'>
        ...
        <div className={`border border-slate-300 bg-slate-100 sm:block pl-5 py-5 mt-6 ${showFilter ? '': 'hidden' } `}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light'>
            <p className='flex gap-2'>
              <input type='radio' value='below40' name='price' onChange={togglepricerange} /> Below 40L
            </p>
              <p className='flex gap-2'>
              <input type='radio' value='40-60' name='price' onChange={togglepricerange} /> 40L-60L
            </p>
              <p className='flex gap-2'>
              <input type='radio' value='60-80' name='price' onChange={togglepricerange} />60L-80L
            </p>
             <p className='flex gap-2'>
              <input type='radio' value='above80' name='price' onChange={togglepricerange} />Above 80L
            </p>
          </div>
        </div>
      </div> 
