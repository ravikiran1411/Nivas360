  ...
  return (
    <div className="w-full flex justify-center">
      <form onSubmit={submitHandler} className="w-full max-w-4xl bg-white p-8 rounded shadow flex flex-col gap-6">
        ...
        <input value={data.title} onChange={(e)=>setData({...data,title:e.target.value})} className="border px-3 py-2 rounded"
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <select className="border px-3 py-2 rounded" value={data.purpose}
            onChange={(e)=>setData({...data,purpose:e.target.value})} >
            <option value="sell">Sell</option>
            <option value="rent">Rent</option>
          </select>

          <select className="border px-3 py-2 rounded" value={data.propertyType}
          ...
          <input type="number" value={data.bhk} onChange={(e)=>setData({...data,bhk:e.target.value})}
            className="border px-3 py-2 rounded w-24" placeholder="BHK" />
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <input type="number" value={data.SqYards} onChange={(e)=>setData({...data,SqYards:e.target.value})}
            className="border px-3 py-2 rounded" placeholder="Sq Yards" />
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <input placeholder="Area" value={data.area}
        ...
        <div>
          ...
          <label className="mr-4">
            <input type="checkbox"
              ...
              onChange={(e)=>setData({...data,parking:{...data.parking,car:e.target.checked}})} /> Car
          </label>

          <label>
            <input type="checkbox"
              checked={data.parking.bike}
              onChange={(e)=>setData({...data,parking:{...data.parking,bike:e.target.checked}})} /> Bike
          </label>
        ...
        <div>
          ...
          <div className="flex gap-3 items-center">
            ...
            <select className="border px-3 py-2 rounded" value={availabilityType}
            ...
            {availabilityType === "After" && (
              <>
                <input type="number" value={availabilityMonths}
        ...
        <button className="bg-black text-white py-3 px-6 rounded w-40 hover:bg-gray-900" type="submit" >
          Add Property
        </button>
      </form>
    </div>
